...
public class ListsofDoctor extends Activity implements View.OnClickListener, OnDSListener, OnDSPermissionsListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listsof_doctor);
    ...
    public void onDroidSpeechLiveResult(String liveSpeechResult)
    {
        ...
        {
            startActivity(new Intent(ListsofDoctor.this, Confirm.class));
