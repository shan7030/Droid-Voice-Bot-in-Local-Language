...
public class SchemeSelection extends Activity implements View.OnClickListener, OnDSListener, OnDSPermissionsListener
{
    ...
    public void onDroidSpeechLiveResult(String liveSpeechResult)
    {
        ...
        if (text.get(0).equals("सेंट्रल")) {
            startActivity(new Intent(SchemeSelection.this, CentralScheme.class));

        }
        else if (text.get(0).equals("स्टेट")) {
            startActivity(new Intent(SchemeSelection.this, statescheme.class));
