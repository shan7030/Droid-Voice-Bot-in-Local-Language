...
public class BookApointment extends Activity  implements View.OnClickListener, OnDSListener, OnDSPermissionsListener {
    ...
    public void onDroidSpeechLiveResult(String liveSpeechResult)
    {
        ...
        {
            startActivity(new Intent(BookApointment.this, ListsofDoctor.class));
