...
public class Confirm  extends Activity implements View.OnClickListener, OnDSListener, OnDSPermissionsListener {
    ...
    public void onDroidSpeechLiveResult(String liveSpeechResult)
    {
        ...
        if(text.get(0).equals("हो"))
        {
            Toast toast = Toast.makeText(getApplicationContext(), "Booking Confirmed!", Toast.LENGTH_SHORT); toast.show();
            startActivity(new Intent(Confirm.this, Activity_DroidSpeech.class));
